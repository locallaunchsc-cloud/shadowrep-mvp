    ...
    <>
      ...
      <main className="relative min-h-screen overflow-hidden">
        <div className="blob-field">
          <div className="blob blob-cyber animate-blob-1 absolute left-[-10%] top-0 h-[420px] w-[420px] opacity-35" />
          <div className="blob blob-iris animate-blob-3 absolute right-[-10%] top-40 h-[380px] w-[380px] opacity-30" />
        </div>
        ...
        <section className="relative mx-auto max-w-5xl px-6 py-14">
          <div>
            ...
            <h1 className="mt-3 font-display text-4xl font-black tracking-tight sm:text-6xl">
              Create a <span className="holo-text">private gate.</span>
            </h1>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <div className="mt-7 grid gap-5">
                <label className="grid gap-2">
                  ...
                  <input
                    ...
                    className="rounded-2xl border border-white/10 bg-black/40 px-4 py-3 text-sm outline-none transition focus:border-acid/40 focus:bg-black/60 focus:shadow-ring"
                  />
                </label>
            ...
            {/* Preview */}
            <div className="conic-border rounded-3xl p-7">
              ...
              <pre className="mt-3 overflow-auto rounded-2xl border border-white/[0.06] bg-black/60 p-4 text-[11px] leading-relaxed text-cyber">
{JSON.stringify(
  ...
  2
              ...
              <div className="mt-6 space-y-2">
                ...
                <div className="break-all rounded-2xl border border-white/[0.06] bg-black/60 p-3 font-mono text-[11px] text-acid">
                  {link}
                </div>
              </div>

              <div className="mt-6 flex flex-wrap gap-2">
                <Link href={path} className="btn-acid">
                  Open verify page
